...
"use strict";var React=require("react"),ReactDOM=require("react-dom"),Store=require("./src/Store"),ViewCtrl=require("./src/ViewCtrl");!function(e){ReactDOM.render(React.createElement(ViewCtrl,{store:Store()}),e.getElementById("app"))}(window.document);

},{"./src/Store":161,"./src/ViewCtrl":162,"react":159,"react-dom":3}],2:[function(require,module,exports){
...
"use strict";var React=require("react");module.exports=React.createClass({displayName:"exports",render:function(){return React.createElement("div",{className:"shape shape-"+this.props.type,onClick:this.props.onSelect},this.props.type)}});

},{"react":159}],161:[function(require,module,exports){
"use strict";var rules=require("./rules"),shapes=Object.keys(rules.winner);module.exports=function(){var e={},n=function(e){return Math.floor(Math.random()*e)},t=function(e,t){return e[(t||n)(e.length)]};return{selectShapes:function(n,r){r=r||t(shapes),e={shape1:n,shape2:r,winner:rules.winner[n][r]||0}},getRandomElem:t,getRandomIntExcluding:n,restart:function(){e={}},getState:function(){return e}}};

},{"./rules":163}],162:[function(require,module,exports){
"use strict";var React=require("react"),Shape=require("./Shape"),rules=require("./rules"),shapes=Object.keys(rules.winner);module.exports=React.createClass({displayName:"exports",getInitialState:function(){return this.props.store.getState()},render:function(){var e=this,t=this.props.store,a=void 0!==this.state.winner,r={undefined:"Choose your figure",0:"Stalemate!",1:"You win!",2:"You lose =("},n=function(){e.replaceState(t.getState())},s=function(){t.restart(),n()},c=function(e){a||(t.selectShapes(e),n())};return React.createElement("div",{className:"board"},React.createElement("header",null,React.createElement("h1",null,r[this.state.winner])),React.createElement("section",{className:"opponent"},React.createElement(Shape,{type:this.state.shape2||"?"})),React.createElement("section",{className:"player"},shapes.map(function(e){return React.createElement(Shape,{type:e,onSelect:function(){return c(e)}})})),React.createElement("footer",null,React.createElement("button",{className:"btn-restart"+(a?" btn-visible":""),onClick:s},"Play again?")))}});

},{"./Shape":160,"./rules":163,"react":159}],163:[function(require,module,exports){
"use strict";module.exports={winner:{rock:{paper:2,scissors:1},paper:{rock:1,scissors:2},scissors:{rock:2,paper:1}}};
